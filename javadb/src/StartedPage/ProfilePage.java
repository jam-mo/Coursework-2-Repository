...
public class ProfilePage extends javax.swing.JFrame {
    ...
    Connection con = null;
    String Cuser_ID = "17710"; //should be input retrieved when account is logged into
    int languages_ID = 41470; // also needs to be retrieved elsewhere
    int Userinput;                                                  //User input from submit button

    public ProfilePage() {                                                    // Profile page method which is used to run all other methods essentially creating the popup and changing the information
        ...
        jButton1.addActionListener(new ActionListener() {        //home button
        ...
        jButton2.addActionListener(new ActionListener() {       // level button
         public void actionPerformed(ActionEvent e) {
             System.out.println("PLACEHOLDER");
        ...
        jButton3.addActionListener(new ActionListener() {        // Logout button
         public void actionPerformed(ActionEvent e) {
             System.out.println("PLACEHOLDER");
        ...
        jButton4.addActionListener(new ActionListener() {     // back button
         public void actionPerformed(ActionEvent e) {
             System.out.println("PLACEHOLDER");
            
         }
      });
        jButton5.addActionListener(new ActionListener() {      //submit button which adds the textfield integers to the program database
         public void actionPerformed(ActionEvent e) {
             System.out.println("PLACEHOLDER");
    ...
    ResultSet rs = null ;                                                       //ResultSet object created and initilised
        ...
        String readWord = "SELECT username from USERS where user_ID = ?";       //Query to be ran in a string
                ...
                ps.setString(1, Cuser_ID);                                      //ps statement first ? is set as Cuser_ID
